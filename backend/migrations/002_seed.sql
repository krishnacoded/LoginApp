-- PeopleFlow Seed Data
BEGIN;

-- Insert Roles
INSERT INTO roles (name, description, permissions) VALUES
  ('admin', 'System Administrator', '["all"]'),
  ('hr', 'Human Resources Manager', '["employees:all","leaves:all","departments:all","skills:all","reports:view"]'),
  ('manager', 'Team Manager', '["employees:view","leaves:approve","team:manage"]'),
  ('employee', 'Regular Employee', '["leaves:apply","profile:edit","documents:upload"]')
ON CONFLICT (name) DO NOTHING;

-- Insert Skill Categories
INSERT INTO skill_categories (id, name, description, color) VALUES
  ('11111111-1111-1111-1111-111111111001', 'Technical', 'Programming languages, frameworks, tools', '#4F46E5'),
  ('11111111-1111-1111-1111-111111111002', 'Soft Skills', 'Communication, leadership, teamwork', '#7C3AED'),
  ('11111111-1111-1111-1111-111111111003', 'Management', 'Project management, team leadership', '#0047AB'),
  ('11111111-1111-1111-1111-111111111004', 'Domain Knowledge', 'Industry-specific knowledge', '#059669')
ON CONFLICT (name) DO NOTHING;

-- Insert Skills
INSERT INTO skills (name, category_id, description) VALUES
  ('JavaScript', '11111111-1111-1111-1111-111111111001', 'JavaScript programming language'),
  ('TypeScript', '11111111-1111-1111-1111-111111111001', 'TypeScript superset of JavaScript'),
  ('React.js', '11111111-1111-1111-1111-111111111001', 'React frontend framework'),
  ('Node.js', '11111111-1111-1111-1111-111111111001', 'Node.js runtime environment'),
  ('Python', '11111111-1111-1111-1111-111111111001', 'Python programming language'),
  ('PostgreSQL', '11111111-1111-1111-1111-111111111001', 'PostgreSQL database'),
  ('MongoDB', '11111111-1111-1111-1111-111111111001', 'MongoDB NoSQL database'),
  ('Docker', '11111111-1111-1111-1111-111111111001', 'Docker containerization'),
  ('AWS', '11111111-1111-1111-1111-111111111001', 'Amazon Web Services'),
  ('Communication', '11111111-1111-1111-1111-111111111002', 'Verbal and written communication'),
  ('Leadership', '11111111-1111-1111-1111-111111111002', 'Team leadership and mentoring'),
  ('Problem Solving', '11111111-1111-1111-1111-111111111002', 'Analytical and creative problem solving'),
  ('Project Management', '11111111-1111-1111-1111-111111111003', 'Project planning and execution'),
  ('Agile/Scrum', '11111111-1111-1111-1111-111111111003', 'Agile methodologies and Scrum'),
  ('Data Analysis', '11111111-1111-1111-1111-111111111004', 'Business data analysis'),
  ('Machine Learning', '11111111-1111-1111-1111-111111111001', 'ML algorithms and frameworks'),
  ('UI/UX Design', '11111111-1111-1111-1111-111111111001', 'User interface and experience design'),
  ('DevOps', '11111111-1111-1111-1111-111111111001', 'Development operations and CI/CD')
ON CONFLICT DO NOTHING;

-- Insert Departments
INSERT INTO departments (id, name, code, description, location) VALUES
  ('22222222-2222-2222-2222-222222222001', 'Engineering', 'ENG', 'Software Engineering & Development', 'Floor 3'),
  ('22222222-2222-2222-2222-222222222002', 'Human Resources', 'HR', 'People Operations & Culture', 'Floor 1'),
  ('22222222-2222-2222-2222-222222222003', 'Product', 'PROD', 'Product Management & Design', 'Floor 2'),
  ('22222222-2222-2222-2222-222222222004', 'Sales', 'SALES', 'Revenue & Business Development', 'Floor 1'),
  ('22222222-2222-2222-2222-222222222005', 'Finance', 'FIN', 'Financial Operations & Accounting', 'Floor 2'),
  ('22222222-2222-2222-2222-222222222006', 'Marketing', 'MKT', 'Brand, Content & Digital Marketing', 'Floor 1'),
  ('22222222-2222-2222-2222-222222222007', 'Operations', 'OPS', 'Business Operations & Administration', 'Floor 4'),
  ('22222222-2222-2222-2222-222222222008', 'Legal', 'LEG', 'Legal & Compliance', 'Floor 5')
ON CONFLICT (code) DO NOTHING;

-- Insert Leave Types
INSERT INTO leave_types (name, code, description, color, max_days_per_year, carry_forward, max_carry_forward_days, is_paid) VALUES
  ('Casual Leave', 'CL', 'For personal reasons and casual absences', '#4F46E5', 12, FALSE, 0, TRUE),
  ('Sick Leave', 'SL', 'For medical and health reasons', '#DC2626', 10, FALSE, 0, TRUE),
  ('Paid Leave', 'PL', 'Annual paid vacation leave', '#059669', 15, TRUE, 5, TRUE),
  ('Unpaid Leave', 'UL', 'Leave without pay', '#6B7280', 30, FALSE, 0, FALSE),
  ('Emergency Leave', 'EL', 'For urgent family or personal emergencies', '#D97706', 3, FALSE, 0, TRUE),
  ('Maternity Leave', 'ML', 'Maternity leave for new mothers', '#7C3AED', 182, FALSE, 0, TRUE),
  ('Paternity Leave', 'PTL', 'Paternity leave for new fathers', '#0047AB', 15, FALSE, 0, TRUE),
  ('Bereavement Leave', 'BL', 'Leave due to death in family', '#374151', 5, FALSE, 0, TRUE)
ON CONFLICT (code) DO NOTHING;

-- Insert Leave Balances for seed employees
...
-- i-SOFTZONE Technologies Pvt Ltd demo dataset
INSERT INTO departments (id, name, code, description, location) VALUES
