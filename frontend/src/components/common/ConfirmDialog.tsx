            ...
            <div className="glass-card rounded-2xl p-6">
              <div className="flex items-start gap-4 mb-5">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                  style={{ background: danger ? 'rgba(239,68,68,0.15)' : 'rgba(48,127,226,0.15)' }}>
                  <AlertTriangle size={18} style={{ color: danger ? '#f87171' : '#307FE2' }} />
                </div>
                <div>
              ...
              <div className="flex items-center gap-3 justify-end">
                ...
                <button
                  onClick={onConfirm}
                  disabled={isLoading}
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all disabled:opacity-50 ${danger ? 'text-white' : 'text-[#001133]'}`}
                  style={{
                    background: danger
                      ? 'linear-gradient(135deg, #dc2626, #b91c1c)'
                      : 'linear-gradient(135deg, #FFE264, #F2A900)',
                  }}
                >
